Shader "Node Notes/Geometry/Bevel Atlased Projected" {
	Properties{
	...
	SubShader {
		...
		Pass {
			...
			float4 frag(v2f i) : SV_Target {
				...
				float ambientOcclusion = 1 - (1 - bumpMap.a)*dotprod;
			...
			/*	float4 _BG_GRAD_COL_1;
				...
				float up = (normal.y + 1)*0.5;

				col.rgb *= sqrt(_BG_GRAD_COL_1.rgb*_BG_GRAD_COL_1.rgb*up + _BG_GRAD_COL_2 * _BG_GRAD_COL_2*(1 - up))*ambientOcclusion;// *ambientBlock;
