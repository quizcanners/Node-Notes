...
namespace NodeNotes_Visual {
    ...
    public class Interaction : AbstractKeepUnrecognizedCfg, IPEGI, IGotDisplayName, IAmConditional, INeedAttention, IPEGI_ListInspect {
        ...
        public override bool Inspect() {
            ...
            if (_inspectedItems == -1)
               pegi.FullWindowService.fullWindowDocumentationClickOpen("Results that will be set the moment any choice is picked, before the text that goes after it", "About Final Results");
